        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-6 col-lg-4 col-12 ft-3">
              <h5>My Infos</h5>
              <p>
                <i class="fa-solid fa-phone-volume"></i> +216 20835573
              </p>
              <p>
                <i class="fa-solid fa-envelope"></i> yassinezehani@gmail.com
              </p>
              <p>
                <i class="fa-solid fa-paper-plane"></i> Tunisia , Manouba.
              </p>
            </div>
          </div>
        </div>
